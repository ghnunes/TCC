...
LC_2015 <- read.csv("tri_50k_SEM_normalizar_INGLES_2015.csv", sep=",")
LC_2015$X<-NULL
LC_2015<-LC_2015[,-4]

LC_2014 <- read.csv("tri_50k_SEM_normalizar_INGLES_2014.csv", sep=",")
LC_2014$X<-NULL
LC_2014<-LC_2014[,-4]

LC_2013 <- read.csv("tri_50k_SEM_normalizar_INGLES_2013.csv", sep=",")
LC_2013$X<-NULL
LC_2013<-LC_2014[,-4]

LC_2012 <- read.csv("tri_50k_SEM_normalizar_INGLES_2012.csv", sep=",")
LC_2012$X<-NULL
LC_2012<-LC_2012[,-4]

LC_2011 <- read.csv("tri_50k_SEM_normalizar_INGLES_2011.csv", sep=",")
LC_2011$X<-NULL
LC_2011<-LC_2011[,-4]

LC_2010 <- read.csv("tri_50k_SEM_normalizar_INGLES_2010.csv", sep=",")
LC_2010$X<-NULL
LC_2010<-LC_2010[,-4]
...
write.csv(questoes_classificadas, file = "questoes_INGLES_classificadas.csv")
