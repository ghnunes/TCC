...
gabarito_azul_LC <- c("5","5","5","5","5","C","E","E","C","C","A","E","D","E","D","D","B","B","A","C","C","C","E","B","B","E","B","D","A","A","C","D","B","C","D","E","D","A","D","D","A","B","A","D","A")
...
#nrow(dados) 
  for(i in 1:nrow(dados)){ 
      ...
      if(dados[i,5]==95 || 111){ #prova AZUL
      ...
      if(dados[i,5]== 93 || 109){ #prova amarela
        ...
        if(gabarito_azul_LC[18]==vet_respostas[110-90]){
          respostas_LC[contadorAux,13]<-1
        }
        ...
        if(gabarito_azul_LC[20]==vet_respostas[105-90]){
          respostas_LC[contadorAux,15]<-1
        }
        ...
        if(gabarito_azul_LC[22]==vet_respostas[112-90]){
          respostas_LC[contadorAux,17]<-1
        }
        
        if(gabarito_azul_LC[23]==vet_respostas[116-90]){
          respostas_LC[contadorAux,18]<-1
        }
        ...
        if(gabarito_azul_LC[29]==vet_respostas[117-90]){
          respostas_LC[contadorAux,24]<-1
        }
        ...
        if(gabarito_azul_LC[35]==vet_respostas[126-90]){
          respostas_LC[contadorAux,30]<-1
        }
        ...
        if(gabarito_azul_LC[39]==vet_respostas[128-90]){
          respostas_LC[contadorAux,34]<-1
        }
      ...
      if(dados[i,5]==94 || 110){ #prova cinza
        #Começo da posição 6, porque as 5 primeiras são de inglês ou espanhol.
        if(gabarito_azul_LC[6]==vet_respostas[96-90]){
          respostas_LC[contadorAux,1]<-1
        }
        ...
        if(gabarito_azul_LC[8]==vet_respostas[99-90]){
          respostas_LC[contadorAux,3]<-1
        } 
        if(gabarito_azul_LC[9]==vet_respostas[98-90]){
          respostas_LC[contadorAux,4]<-1
        }
        ...
        if(gabarito_azul_LC[11]==vet_respostas[101-90]){
          respostas_LC[contadorAux,6]<-1
        }
        ...
        if(gabarito_azul_LC[24]==vet_respostas[113-90]){
          respostas_LC[contadorAux,19]<-1
        }
        ...
        if(gabarito_azul_LC[26]==vet_respostas[114-90]){
          respostas_LC[contadorAux,21]<-1
        }
        ...
        if(gabarito_azul_LC[28]==vet_respostas[117-90]){
          respostas_LC[contadorAux,23]<-1
        }
        ...
        if(gabarito_azul_LC[45]==vet_respostas[134-90]){
          respostas_LC[contadorAux,40]<-1
        }
      }
      
      if(dados[i,5]==96 || 112){ #prova rosa
        ...
        if(gabarito_azul_LC[11]==vet_respostas[102-90]){
          respostas_LC[contadorAux,6]<-1
        }
