...
gabarito_CN <- c("B","A","C","E","A","D","C","A","E","C","A","B","D","D","A","C","B","A","B","E","B","D","E","D","A","E","E","C","B","D","C","D","B","D","E","E","A","B","D","A","C","E","D","D","C")
...
resposta = ""
  ...
  for(i in 1:nrow(dados)){
      ...
      if(dados[i,4]==89 || 105){ #prova azul
      ...
      if(dados[i,4]==90 || 106){ #prova amarela
        ...
        if(gabarito_CN[4]==vet_respostas[49-45]){
          respostas_CN[contadorAux,4]<-1
        }
        ...
        if(gabarito_CN[6]==vet_respostas[55-45]){
          respostas_CN[contadorAux,6]<-1
        }
        
        if(gabarito_CN[7]==vet_respostas[52-45]){
          respostas_CN[contadorAux,7]<-1
        }
        
        if(gabarito_CN[8]==vet_respostas[54-45]){
          respostas_CN[contadorAux,8]<-1
        }
        
        if(gabarito_CN[9]==vet_respostas[53-45]){
          respostas_CN[contadorAux,9]<-1
        }
        
        if(gabarito_CN[10]==vet_respostas[51-45]){
          respostas_CN[contadorAux,10]<-1
        }
        
        if(gabarito_CN[11]==vet_respostas[60-45]){
          respostas_CN[contadorAux,11]<-1
        }
        
        if(gabarito_CN[12]==vet_respostas[59-45]){
          respostas_CN[contadorAux,12]<-1
        }
        ...
        if(gabarito_CN[14]==vet_respostas[57-45]){
          respostas_CN[contadorAux,14]<-1
        }
        
        if(gabarito_CN[15]==vet_respostas[56-45]){
          respostas_CN[contadorAux,15]<-1
        }
        
        if(gabarito_CN[16]==vet_respostas[61-45]){
          respostas_CN[contadorAux,16]<-1
        }
        
        if(gabarito_CN[17]==vet_respostas[66-45]){
          respostas_CN[contadorAux,17]<-1
        }
        ...
        if(gabarito_CN[21]==vet_respostas[62-45]){
          respostas_CN[contadorAux,21]<-1
        }
        ...
        if(gabarito_CN[24]==vet_respostas[71-45]){
          respostas_CN[contadorAux,24]<-1
        }
        
        if(gabarito_CN[25]==vet_respostas[70-45]){
          respostas_CN[contadorAux,25]<-1
        }
        ...
        if(gabarito_CN[27]==vet_respostas[68-45]){
          respostas_CN[contadorAux,27]<-1
        }
        
        if(gabarito_CN[28]==vet_respostas[78-45]){
          respostas_CN[contadorAux,28]<-1
        }
        
        if(gabarito_CN[29]==vet_respostas[74-45]){
          respostas_CN[contadorAux,29]<-1
        }
        ...
        if(gabarito_CN[31]==vet_respostas[76-45]){
          respostas_CN[contadorAux,31]<-1
        }
        
        if(gabarito_CN[32]==vet_respostas[73-45]){
          respostas_CN[contadorAux,32]<-1
        }
        
        if(gabarito_CN[33]==vet_respostas[75-45]){
          respostas_CN[contadorAux,33]<-1
        }
        ...
        if(gabarito_CN[35]==vet_respostas[84-45]){
          respostas_CN[contadorAux,35]<-1
        }
        ...
        if(gabarito_CN[37]==vet_respostas[82-45]){
          respostas_CN[contadorAux,37]<-1
        }
        ...
        if(gabarito_CN[39]==vet_respostas[80-45]){
          respostas_CN[contadorAux,39]<-1
        }
        ...
        if(gabarito_CN[41]==vet_respostas[90-45]){
          respostas_CN[contadorAux,41]<-1
        }
        ...
        if(gabarito_CN[43]==vet_respostas[88-45]){
          respostas_CN[contadorAux,43]<-1
        }
        
        if(gabarito_CN[44]==vet_respostas[87-45]){
          respostas_CN[contadorAux,44]<-1
        }
      ...
      if(dados[i,4]== 91 || 107){ #prova branca
        if(gabarito_CN[1]==vet_respostas[48-45]){
          respostas_CN[contadorAux,1]<-1
        }
        
        if(gabarito_CN[2]==vet_respostas[50-45]){
          respostas_CN[contadorAux,2]<-1
        }
        
        if(gabarito_CN[3]==vet_respostas[46-45]){
          respostas_CN[contadorAux,3]<-1
        }
        ...
        if(gabarito_CN[5]==vet_respostas[47-45]){
          respostas_CN[contadorAux,5]<-1
        }
        
        if(gabarito_CN[6]==vet_respostas[53-45]){
          respostas_CN[contadorAux,6]<-1
        }
        ...
        if(gabarito_CN[8]==vet_respostas[51-45]){
          respostas_CN[contadorAux,8]<-1
        }
        
        if(gabarito_CN[9]==vet_respostas[55-45]){
          respostas_CN[contadorAux,9]<-1
        }
        
        if(gabarito_CN[10]==vet_respostas[54-45]){
          respostas_CN[contadorAux,10]<-1
        }
        
        if(gabarito_CN[11]==vet_respostas[59-45]){
          respostas_CN[contadorAux,11]<-1
        }
        
        if(gabarito_CN[12]==vet_respostas[56-45]){
          respostas_CN[contadorAux,12]<-1
        }
        ...
        if(gabarito_CN[15]==vet_respostas[57-45]){
          respostas_CN[contadorAux,15]<-1
        }
        ...
        if(gabarito_CN[17]==vet_respostas[65-45]){
          respostas_CN[contadorAux,17]<-1
        }
        
        if(gabarito_CN[18]==vet_respostas[66-45]){
          respostas_CN[contadorAux,18]<-1
        }
        ...
        if(gabarito_CN[20]==vet_respostas[62-45]){
          respostas_CN[contadorAux,20]<-1
        }
        ...
        if(gabarito_CN[23]==vet_respostas[71-45]){
          respostas_CN[contadorAux,23]<-1
        }
        
        if(gabarito_CN[24]==vet_respostas[68-45]){
          respostas_CN[contadorAux,24]<-1
        }
        ...
        if(gabarito_CN[28]==vet_respostas[77-45]){
          respostas_CN[contadorAux,28]<-1
        }
        ...
        if(gabarito_CN[30]==vet_respostas[78-45]){
          respostas_CN[contadorAux,30]<-1
        }
        ...
        if(gabarito_CN[33]==vet_respostas[73-45]){
          respostas_CN[contadorAux,33]<-1
        }
        ...
        if(gabarito_CN[35]==vet_respostas[83-45]){
          respostas_CN[contadorAux,35]<-1
        }
        
        if(gabarito_CN[36]==vet_respostas[84-45]){
          respostas_CN[contadorAux,36]<-1
        }
        ...
        if(gabarito_CN[38]==vet_respostas[80-45]){
          respostas_CN[contadorAux,38]<-1
        }
        
        if(gabarito_CN[39]==vet_respostas[81-45]){
          respostas_CN[contadorAux,39]<-1
        }
        ...
        if(gabarito_CN[41]==vet_respostas[89-45]){
          respostas_CN[contadorAux,41]<-1
        }
        
        if(gabarito_CN[42]==vet_respostas[90-45]){
          respostas_CN[contadorAux,42]<-1
        }
        ...
        if(gabarito_CN[44]==vet_respostas[86-45]){
          respostas_CN[contadorAux,44]<-1
        }
        
        if(gabarito_CN[45]==vet_respostas[87-45]){
          respostas_CN[contadorAux,45]<-1
        } 
      }
      
      if(dados[i,4]==92 || 108){ #prova rosa
        ...
        if(gabarito_CN[3]==vet_respostas[50-45]){
          respostas_CN[contadorAux,3]<-1
        }
        ...
        if(gabarito_CN[6]==vet_respostas[54-45]){
          respostas_CN[contadorAux,6]<-1
        }
        ...
        if(gabarito_CN[9]==vet_respostas[51-45]){
          respostas_CN[contadorAux,9]<-1
        }
        ...
        if(gabarito_CN[12]==vet_respostas[60-45]){
          respostas_CN[contadorAux,12]<-1
        }
        ...
        if(gabarito_CN[14]==vet_respostas[56-45]){
          respostas_CN[contadorAux,14]<-1
        }
        ...
        if(gabarito_CN[17]==vet_respostas[63-45]){
          respostas_CN[contadorAux,17]<-1
        }
        
        if(gabarito_CN[18]==vet_respostas[62-45]){
          respostas_CN[contadorAux,18]<-1
        }
        ...
        if(gabarito_CN[21]==vet_respostas[65-45]){
          respostas_CN[contadorAux,21]<-1
        }
        ...
        if(gabarito_CN[23]==vet_respostas[69-45]){
          respostas_CN[contadorAux,23]<-1
        }
        ...
        if(gabarito_CN[26]==vet_respostas[68-45]){
          respostas_CN[contadorAux,26]<-1
        }
        ...
        if(gabarito_CN[30]==vet_respostas[73-45]){
          respostas_CN[contadorAux,30]<-1
        }
        ...
        if(gabarito_CN[39]==vet_respostas[83-45]){
          respostas_CN[contadorAux,39]<-1
        }
        ...
        if(gabarito_CN[41]==vet_respostas[87-45]){
          respostas_CN[contadorAux,41]<-1
        }
        
        if(gabarito_CN[42]==vet_respostas[86-45]){
          respostas_CN[contadorAux,42]<-1
        }
