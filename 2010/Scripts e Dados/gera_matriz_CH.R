...
library(progress)
dados <- read.csv.ffdf(file='amostra_enem2010_50k.csv', header=T, sep=',', VERBOSE=T, next.rows=500000, colClasses=NA)
...
gabarito_CH <- c("A","B","A","B","D","A","C","B","A","E","B","C","C","C","B","E","A","B","C","C","A","D","B","B","C","C","D","E","C","E","E","D","B","E","D","B","A","E","A","E","D","E","C","D","D")
...
resposta <- ""
  ...
  for(i in 1:nrow(dados)){
      ...
      if(dados[i,5]==85 || 101){ #prova azul
      ...
      if(dados[i,5]==86 || 102){ #prova amarela
        if(gabarito_CH[1]==vet_respostas[2]){
          respostas_CH[contadorAux,1]<-1
        }
        ...
        if(gabarito_CH[8]==vet_respostas[11]){
          respostas_CH[contadorAux,8]<-1
        }
        ...
        if(gabarito_CH[11]==vet_respostas[8]){
          respostas_CH[contadorAux,11]<-1
        }
        ...
        if(gabarito_CH[15]==vet_respostas[18]){
          respostas_CH[contadorAux,15]<-1
        }
        ...
        if(gabarito_CH[17]==vet_respostas[14]){
          respostas_CH[contadorAux,17]<-1
        }
        ...
        if(gabarito_CH[24]==vet_respostas[29]){
          respostas_CH[contadorAux,24]<-1
        }
        ...
        if(gabarito_CH[27]==vet_respostas[26]){
          respostas_CH[contadorAux,27]<-1
        }
        
        if(gabarito_CH[28]==vet_respostas[35]){
          respostas_CH[contadorAux,28]<-1
        }
        ...
        if(gabarito_CH[36]==vet_respostas[39]){
          respostas_CH[contadorAux,36]<-1
        }
        ...
        if(gabarito_CH[38]==vet_respostas[36]){
          respostas_CH[contadorAux,38]<-1
        }
        
        if(gabarito_CH[39]==vet_respostas[41]){
          respostas_CH[contadorAux,39]<-1
        }
        ...
        if(gabarito_CH[41]==vet_respostas[30]){
          respostas_CH[contadorAux,41]<-1
        }
        ...
        if(gabarito_CH[45]==vet_respostas[44]){
          respostas_CH[contadorAux,45]<-1
        } 
      }
  
      if(dados[i,5]== 87 || 103){ #prova branca
        if(gabarito_CH[1]==vet_respostas[1]){
          respostas_CH[contadorAux,1]<-1
        }
        ...
        if(gabarito_CH[9]==vet_respostas[10]){
          respostas_CH[contadorAux,9]<-1
        }
        ...
        if(gabarito_CH[12]==vet_respostas[9]){
          respostas_CH[contadorAux,12]<-1
        }
        ...
        if(gabarito_CH[20]==vet_respostas[21]){
          respostas_CH[contadorAux,20]<-1
        }
        
        if(gabarito_CH[21]==vet_respostas[20]){
          respostas_CH[contadorAux,21]<-1
        }
        ...
        if(gabarito_CH[24]==vet_respostas[23]){
          respostas_CH[contadorAux,24]<-1
        }
        ...
        if(gabarito_CH[28]==vet_respostas[27]){
          respostas_CH[contadorAux,28]<-1
        }
        ...
        if(gabarito_CH[30]==vet_respostas[29]){
          respostas_CH[contadorAux,30]<-1
        }
        ...
        if(gabarito_CH[32]==vet_respostas[35]){
          respostas_CH[contadorAux,32]<-1
        }
        ...
        if(gabarito_CH[35]==vet_respostas[33]){
          respostas_CH[contadorAux,35]<-1
        }
        ...
        if(gabarito_CH[39]==vet_respostas[36]){
          respostas_CH[contadorAux,39]<-1
        }
        ...
        if(gabarito_CH[42]==vet_respostas[44]){
          respostas_CH[contadorAux,42]<-1
        }
      ...
      if(dados[i,5]==88 || 104){ #prova rosa
        if(gabarito_CH[1]==vet_respostas[2]){
          respostas_CH[contadorAux,1]<-1
        }
        ...
        if(gabarito_CH[5]==vet_respostas[9]){
          respostas_CH[contadorAux,5]<-1
        }
        
        if(gabarito_CH[6]==vet_respostas[10]){
          respostas_CH[contadorAux,6]<-1
        }
        ...
        if(gabarito_CH[10]==vet_respostas[11]){
          respostas_CH[contadorAux,10]<-1
        }
        ...
        if(gabarito_CH[21]==vet_respostas[23]){
          respostas_CH[contadorAux,21]<-1
        }
        ...
        if(gabarito_CH[29]==vet_respostas[28]){
          respostas_CH[contadorAux,29]<-1
        }
        
        if(gabarito_CH[30]==vet_respostas[27]){
          respostas_CH[contadorAux,30]<-1
        }
        ...
        if(gabarito_CH[32]==vet_respostas[33]){
          respostas_CH[contadorAux,32]<-1
        }
        ...
        if(gabarito_CH[39]==vet_respostas[38]){
          respostas_CH[contadorAux,39]<-1
        }
