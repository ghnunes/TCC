...
dados <-read.csv("amostra_enem2009_50k.csv")
dados$X <- NULL

contadorAux <-0

respostas_LC <- matrix(0, nrow=50000, ncol = 44)
#dentro do vet respostas vai ter que ter as 50 resp
gabarito_azul_LC <- c("A","A","D","A","D","C","D","D","C","E","X","C","C","A","D","D","E","B","C","C","C","C","D","D","E","E","D","C","E","C","B","B","D","D","D","D","C","E","E","C","D","D","C","A","C")
...
#nrow(dados) 
  for(i in 1:nrow(dados)){ 
      ...
      codigo_prova <- (codigo_prova[5:6])
      codigo_prova <- paste(codigo_prova[1],codigo_prova[2])
      
    
      if(codigo_prova== "5 9"){ #prova azul
        
        if(gabarito_azul_LC[1]==vet_respostas[1]){
          respostas_LC[contadorAux,1]<-1
        }
        
        if(gabarito_azul_LC[2]==vet_respostas[2]){
          respostas_LC[contadorAux,2]<-1
        }
        
        if(gabarito_azul_LC[3]==vet_respostas[3]){
          respostas_LC[contadorAux,3]<-1
        }
        
        if(gabarito_azul_LC[4]==vet_respostas[4]){
          respostas_LC[contadorAux,4]<-1
        }
        
        if(gabarito_azul_LC[5]==vet_respostas[5]){
        ...
        #if(gabarito_azul_LC[11]==vet_respostas[11]){ anulada
        ...
        if(gabarito_azul_LC[42]==vet_respostas[42]){
          respostas_LC[contadorAux,41]<-1
        }
        
        if(gabarito_azul_LC[43]==vet_respostas[43]){
          respostas_LC[contadorAux,42]<-1
        }
        
        if(gabarito_azul_LC[44]==vet_respostas[44]){
          respostas_LC[contadorAux,43]<-1
        }
        
        if(gabarito_azul_LC[45]==vet_respostas[45]){
          respostas_LC[contadorAux,44]<-1
        }
      }
      
     
      if(codigo_prova== "5 7"){ #prova amarela
        
        if(gabarito_azul_LC[1]==vet_respostas[93-90]){
          respostas_LC[contadorAux,1]<-1
        }
        
        if(gabarito_azul_LC[2]==vet_respostas[92-90]){
          respostas_LC[contadorAux,2]<-1
        }
        
        if(gabarito_azul_LC[3]==vet_respostas[91-90]){
          respostas_LC[contadorAux,3]<-1
        }
        
        if(gabarito_azul_LC[4]==vet_respostas[95-90]){
          respostas_LC[contadorAux,4]<-1
        }
        
        if(gabarito_azul_LC[5]==vet_respostas[94-90]){
          respostas_LC[contadorAux,5]<-1
        }
        
        if(gabarito_azul_LC[6]==vet_respostas[98-90]){
          respostas_LC[contadorAux,6]<-1
        }
        ...
        if(gabarito_azul_LC[8]==vet_respostas[96-90]){
          respostas_LC[contadorAux,8]<-1
        } 
        ...
        if(gabarito_azul_LC[13]==vet_respostas[103-90]){
          respostas_LC[contadorAux,12]<-1
        }
        
        if(gabarito_azul_LC[14]==vet_respostas[104-90]){
          respostas_LC[contadorAux,13]<-1
        }
        
        if(gabarito_azul_LC[15]==vet_respostas[106-90]){
          respostas_LC[contadorAux,14]<-1
        }
        ...
        if(gabarito_azul_LC[17]==vet_respostas[108-90]){
          respostas_LC[contadorAux,16]<-1
        }
        ...
        if(gabarito_azul_LC[19]==vet_respostas[109-90]){
          respostas_LC[contadorAux,18]<-1
        }
        
        if(gabarito_azul_LC[20]==vet_respostas[110-90]){
          respostas_LC[contadorAux,19]<-1
        }
        ...
        if(gabarito_azul_LC[22]==vet_respostas[113-90]){
          respostas_LC[contadorAux,21]<-1
        }
        ...
        if(gabarito_azul_LC[28]==vet_respostas[115-90]){
          respostas_LC[contadorAux,27]<-1
        }
        ...
        if(gabarito_azul_LC[31]==vet_respostas[123-90]){
          respostas_LC[contadorAux,30]<-1
        }
        ...
        if(gabarito_azul_LC[33]==vet_respostas[120-90]){
          respostas_LC[contadorAux,32]<-1
        }
        
        if(gabarito_azul_LC[34]==vet_respostas[124-90]){
          respostas_LC[contadorAux,33]<-1
        }
        
        if(gabarito_azul_LC[35]==vet_respostas[125-90]){
          respostas_LC[contadorAux,34]<-1
        }
        
        if(gabarito_azul_LC[36]==vet_respostas[126-90]){
          respostas_LC[contadorAux,35]<-1
        }
        ...
        if(gabarito_azul_LC[42]==vet_respostas[133-90]){
          respostas_LC[contadorAux,41]<-1
        }
        
        if(gabarito_azul_LC[43]==vet_respostas[132-90]){
          respostas_LC[contadorAux,42]<-1
        }
      ...
      if(codigo_prova== "5 8"){ #prova cinza
        
        if(gabarito_azul_LC[1]==vet_respostas[91-90]){
          respostas_LC[contadorAux,1]<-1
        }
        
        if(gabarito_azul_LC[2]==vet_respostas[93-90]){
          respostas_LC[contadorAux,2]<-1
        }
        
        if(gabarito_azul_LC[3]==vet_respostas[92-90]){
          respostas_LC[contadorAux,3]<-1
        }
        ...
        if(gabarito_azul_LC[7]==vet_respostas[98-90]){
          respostas_LC[contadorAux,7]<-1 
        }
        ...
        if(gabarito_azul_LC[15]==vet_respostas[105-90]){
          respostas_LC[contadorAux,14]<-1
        }
        
        if(gabarito_azul_LC[16]==vet_respostas[106-90]){
          respostas_LC[contadorAux,15]<-1
        }
        
        if(gabarito_azul_LC[17]==vet_respostas[107-90]){
          respostas_LC[contadorAux,16]<-1
        }
        
        if(gabarito_azul_LC[18]==vet_respostas[108-90]){
          respostas_LC[contadorAux,17]<-1
        }
        ...
        if(gabarito_azul_LC[21]==vet_respostas[111-90]){
          respostas_LC[contadorAux,20]<-1
        }
        ...
        if(gabarito_azul_LC[23]==vet_respostas[112-90]){
          respostas_LC[contadorAux,22]<-1
        }
        ...
        if(gabarito_azul_LC[27]==vet_respostas[118-90]){
          respostas_LC[contadorAux,26]<-1
        }
        ...
        if(gabarito_azul_LC[31]==vet_respostas[122-90]){
          respostas_LC[contadorAux,30]<-1
        }
        ...
        if(gabarito_azul_LC[33]==vet_respostas[121-90]){
          respostas_LC[contadorAux,32]<-1
        }
      ...
      if(codigo_prova== "6 0"){ #prova rosa
        ...
        if(gabarito_azul_LC[4]==vet_respostas[94-90]){
          respostas_LC[contadorAux,4]<-1
        }
        
        if(gabarito_azul_LC[5]==vet_respostas[95-90]){
          respostas_LC[contadorAux,5]<-1
        }
        ...
        if(gabarito_azul_LC[10]==vet_respostas[100-90]){
          respostas_LC[contadorAux,10]<-1
        }
        ...
        if(gabarito_azul_LC[12]==vet_respostas[102-90]){
          respostas_LC[contadorAux,11]<-1
        }
        ...
        if(gabarito_azul_LC[17]==vet_respostas[106-90]){
          respostas_LC[contadorAux,16]<-1
        }
        ...
        if(gabarito_azul_LC[22]==vet_respostas[111-90]){
          respostas_LC[contadorAux,21]<-1
        }
        ...
        if(gabarito_azul_LC[25]==vet_respostas[117-90]){
          respostas_LC[contadorAux,24]<-1
        }
        
        if(gabarito_azul_LC[26]==vet_respostas[115-90]){
          respostas_LC[contadorAux,25]<-1
        }
        ...
        if(gabarito_azul_LC[32]==vet_respostas[121-90]){
          respostas_LC[contadorAux,31]<-1
        }
        ...
        if(gabarito_azul_LC[42]==vet_respostas[130-90]){
          respostas_LC[contadorAux,41]<-1
        }
        
        if(gabarito_azul_LC[43]==vet_respostas[131-90]){
          respostas_LC[contadorAux,42]<-1
        }
        
        if(gabarito_azul_LC[44]==vet_respostas[132-90]){
          respostas_LC[contadorAux,43]<-1
        }
