...
dados <- read.csv.ffdf(file='DADOS_ENEM_2009.csv', header=F, sep=';', VERBOSE=T, next.rows=500000, colClasses=NA)
dados$X <- NULL
...
write.csv(dados_respondentes,file="amostra_enem2009_50k.csv")
