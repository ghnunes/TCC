...
gabarito_MT <- c("A","D","E","C","C","D","E","D","D","C","A","C","D","E","D","D","E","A","D","D","A","B","D","E","D","D","A","B","E","A","B","E","D","D","E","C","C","B","B","C","B","C","E","B","B")
...
resposta = ""
  ...
  for(i in 1:nrow(dados)){
    ...
    codigo_prova <- (codigo_prova[7:8])
    codigo_prova <- paste(codigo_prova[1],codigo_prova[2])
    
      if(codigo_prova == "6 3"){ #prova azul
      ...
      if(codigo_prova == "6 1"){ #prova amarela
        ...
        if(gabarito_MT[5]==vet_respostas[141-135]){
          respostas_MT[contadorAux,5]<-1
        }
        ...
        if(gabarito_MT[8]==vet_respostas[143-135]){
          respostas_MT[contadorAux,8]<-1
        }
        ...
        if(gabarito_MT[10]==vet_respostas[146-135]){
          respostas_MT[contadorAux,10]<-1
        }
        
        if(gabarito_MT[11]==vet_respostas[148-135]){
          respostas_MT[contadorAux,11]<-1
        }
        
        if(gabarito_MT[12]==vet_respostas[145-135]){
          respostas_MT[contadorAux,12]<-1
        }
        ...
        if(gabarito_MT[17]==vet_respostas[153-135]){
          respostas_MT[contadorAux,17]<-1
        }
        
        if(gabarito_MT[18]==vet_respostas[151-135]){
          respostas_MT[contadorAux,18]<-1
        }
        ...
        if(gabarito_MT[23]==vet_respostas[155-135]){
          respostas_MT[contadorAux,23]<-1
        }
        ...
        if(gabarito_MT[26]==vet_respostas[160-135]){
          respostas_MT[contadorAux,26]<-1
        }
        ...
        if(gabarito_MT[31]==vet_respostas[165-135]){
          respostas_MT[contadorAux,31]<-1
        }
        ...
        if(gabarito_MT[35]==vet_respostas[173-135]){
          respostas_MT[contadorAux,35]<-1
        }
        ...
        if(gabarito_MT[38]==vet_respostas[170-135]){
          respostas_MT[contadorAux,38]<-1
        }
        ...
        if(gabarito_MT[40]==vet_respostas[176-135]){
          respostas_MT[contadorAux,40]<-1
        }
    ...
    if(codigo_prova == "6 2"){ #prova cinza
        if(gabarito_MT[1]==vet_respostas[139-135]){
          respostas_MT[contadorAux,1]<-1
        }
        ...
        if(gabarito_MT[8]==vet_respostas[142-135]){
          respostas_MT[contadorAux,8]<-1
        }
        ...
        if(gabarito_MT[30]==vet_respostas[165-135]){
          respostas_MT[contadorAux,30]<-1
        }
    ...
    if(codigo_prova == "6 4"){ #prova rosa
        ...
        if(gabarito_MT[5]==vet_respostas[140-135]){
          respostas_MT[contadorAux,5]<-1
        }
        ...
        if(gabarito_MT[40]==vet_respostas[178-135]){
          respostas_MT[contadorAux,40]<-1
        }
