...
respostas <- read.csv("respostas_zeros_e_uns50k_LC.csv", sep=",")
respostas$X<-NULL
...
write.csv(mod50k, file = "tri_50k_SEM_normalizar_LC.csv")
...
write.csv(tri50_normalizado, file = "tri_50k_NORMALIZADO_LC.csv")
