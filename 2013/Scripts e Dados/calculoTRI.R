...
respostas <- read.csv("respostas_zeros_e_uns_ESPANHOL.csv", sep=",")
respostas$X<-NULL
...
write.csv(mod50k, file = "tri_50k_SEM_normalizar_ESPANHOL.csv")
...
write.csv(tri50_normalizado, file = "tri_50k_NORMALIZADO_ESPANHOL.csv")
