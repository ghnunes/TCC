...
for(i in 1:nrow(dados)){
  ...
  if(dados[i,6]==145){ #prova amarela
    ...
    if(gabarito_espanhol[2]==vet_respostas[1]){
      respostas_LC[contadorAux,2]<-1
    } 
    
    if(gabarito_espanhol[3]==vet_respostas[2]){
      respostas_LC[contadorAux,3]<-1
    } 
  ...
  if(dados[i,6]==147){ #prova azul
    ...
    if(gabarito_espanhol[4]==vet_respostas[5]){
      respostas_LC[contadorAux,4]<-1
    } 
    
    if(gabarito_espanhol[5]==vet_respostas[4]){
      respostas_LC[contadorAux,5]<-1
    }
  }
