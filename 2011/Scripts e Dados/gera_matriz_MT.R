...
gabarito_MT <- c("E","E","B","A","C","B","B","C","E","E","E","E","C","A","B","D","E","E","C","B","C","D","B","A","C","B","D","E","D","A","D","C","C","B","C","D","C","C","E","C","A","C","C","D","D")
  ...
  for(i in 1:nrow(dados)){
    ...
    for(k in 1:45){
      ...
      if(dados[i,6]==129){ #prova amarela
        if(gabarito_MT[1]==vet_respostas[138-135]){
          respostas_MT[contadorAux,1]<-1
        }
        
        if(gabarito_MT[2]==vet_respostas[139-135]){
          respostas_MT[contadorAux,2]<-1
        }
        
        if(gabarito_MT[3]==vet_respostas[136-135]){
          respostas_MT[contadorAux,3]<-1
        }
        
        if(gabarito_MT[4]==vet_respostas[137-135]){
          respostas_MT[contadorAux,4]<-1
        }
        
        if(gabarito_MT[5]==vet_respostas[142-135]){
          respostas_MT[contadorAux,5]<-1
        }
        ...
        if(gabarito_MT[7]==vet_respostas[148-135]){
          respostas_MT[contadorAux,7]<-1
        }
        ...
        if(gabarito_MT[11]==vet_respostas[143-135]){
          respostas_MT[contadorAux,11]<-1
        }
        
        if(gabarito_MT[12]==vet_respostas[140-135]){
          respostas_MT[contadorAux,12]<-1
        }
        
        if(gabarito_MT[13]==vet_respostas[141-135]){
          respostas_MT[contadorAux,13]<-1
        }
        ...
        if(gabarito_MT[15]==vet_respostas[152-135]){
          respostas_MT[contadorAux,15]<-1
        }
        
        if(gabarito_MT[16]==vet_respostas[154-135]){
          respostas_MT[contadorAux,16]<-1
        }
        
        if(gabarito_MT[17]==vet_respostas[151-135]){
          respostas_MT[contadorAux,17]<-1
        }
        
        if(gabarito_MT[18]==vet_respostas[149-135]){
          respostas_MT[contadorAux,18]<-1
        }
        
        if(gabarito_MT[19]==vet_respostas[150-135]){
          respostas_MT[contadorAux,19]<-1
        }
        
        if(gabarito_MT[20]==vet_respostas[158-135]){
          respostas_MT[contadorAux,20]<-1
        }
        ...
        if(gabarito_MT[23]==vet_respostas[156-135]){
          respostas_MT[contadorAux,23]<-1
        }
        
        if(gabarito_MT[24]==vet_respostas[160-135]){
          respostas_MT[contadorAux,24]<-1
        }
        
        if(gabarito_MT[25]==vet_respostas[162-135]){
          respostas_MT[contadorAux,25]<-1
        }
        ...
        if(gabarito_MT[27]==vet_respostas[161-135]){
          respostas_MT[contadorAux,27]<-1
        }
        ...
        if(gabarito_MT[30]==vet_respostas[170-135]){
          respostas_MT[contadorAux,30]<-1
        }
        
        if(gabarito_MT[31]==vet_respostas[171-135]){
          respostas_MT[contadorAux,31]<-1
        }
        ...
        if(gabarito_MT[36]==vet_respostas[165-135]){
          respostas_MT[contadorAux,36]<-1
        }
        
        if(gabarito_MT[37]==vet_respostas[175-135]){
          respostas_MT[contadorAux,37]<-1
        }
        
        if(gabarito_MT[38]==vet_respostas[176-135]){
          respostas_MT[contadorAux,38]<-1
        }
        ...
        if(gabarito_MT[42]==vet_respostas[178-135]){
          respostas_MT[contadorAux,42]<-1
        }
        
        if(gabarito_MT[43]==vet_respostas[177-135]){
          respostas_MT[contadorAux,43]<-1
        }
        
        if(gabarito_MT[44]==vet_respostas[180-135]){
          respostas_MT[contadorAux,44]<-1
        }
        
        if(gabarito_MT[45]==vet_respostas[179-135]){
          respostas_MT[contadorAux,45]<-1
        } 
      }
      
      if(dados[i,6]==130 || 136){ #prova cinza
        ...
        if(gabarito_MT[7]==vet_respostas[145-135]){
          respostas_MT[contadorAux,7]<-1
        }
        
        if(gabarito_MT[8]==vet_respostas[146-135]){
          respostas_MT[contadorAux,8]<-1
        }
        ...
        if(gabarito_MT[15]==vet_respostas[149-135]){
          respostas_MT[contadorAux,15]<-1
        }
        ...
        if(gabarito_MT[17]==vet_respostas[154-135]){
          respostas_MT[contadorAux,17]<-1
        }
        
        if(gabarito_MT[18]==vet_respostas[152-135]){
          respostas_MT[contadorAux,18]<-1
        }
        
        if(gabarito_MT[19]==vet_respostas[153-135]){
          respostas_MT[contadorAux,19]<-1
        }
        
        if(gabarito_MT[20]==vet_respostas[157-135]){
          respostas_MT[contadorAux,20]<-1
        }
        
        if(gabarito_MT[21]==vet_respostas[158-135]){
          respostas_MT[contadorAux,21]<-1
        }
        
        if(gabarito_MT[22]==vet_respostas[155-135]){
          respostas_MT[contadorAux,22]<-1
        }
        ...
        if(gabarito_MT[25]==vet_respostas[161-135]){
          respostas_MT[contadorAux,25]<-1
        }
        
        if(gabarito_MT[26]==vet_respostas[162-135]){
          respostas_MT[contadorAux,26]<-1
        }
        
        if(gabarito_MT[27]==vet_respostas[159-135]){
          respostas_MT[contadorAux,27]<-1
        }
        
        if(gabarito_MT[28]==vet_respostas[163-135]){
          respostas_MT[contadorAux,28]<-1
        }
        ...
        if(gabarito_MT[30]==vet_respostas[166-135]){
          respostas_MT[contadorAux,30]<-1
        }
        
        if(gabarito_MT[31]==vet_respostas[167-135]){
          respostas_MT[contadorAux,31]<-1
        }
        
        if(gabarito_MT[32]==vet_respostas[169-135]){
          respostas_MT[contadorAux,32]<-1
        }
        ...
        if(gabarito_MT[34]==vet_respostas[165-135]){
          respostas_MT[contadorAux,34]<-1
        }
        ...
        if(gabarito_MT[39]==vet_respostas[176-135]){
          respostas_MT[contadorAux,39]<-1
        }
        
        if(gabarito_MT[40]==vet_respostas[177-135]){
          respostas_MT[contadorAux,40]<-1
        }
        ...
        if(gabarito_MT[42]==vet_respostas[175-135]){
          respostas_MT[contadorAux,42]<-1
        }
        ...
        if(gabarito_MT[44]==vet_respostas[173-135]){
          respostas_MT[contadorAux,44]<-1
        }
        
        if(gabarito_MT[45]==vet_respostas[172-135]){
          respostas_MT[contadorAux,45]<-1
        } 
      }
   
      if(dados[i,6]==132){ #prova rosa
        if(gabarito_MT[1]==vet_respostas[137-135]){
          respostas_MT[contadorAux,1]<-1
        }
        
        if(gabarito_MT[2]==vet_respostas[136-135]){
          respostas_MT[contadorAux,2]<-1
        }
        
        if(gabarito_MT[3]==vet_respostas[139-135]){
          respostas_MT[contadorAux,3]<-1
        }
        
        if(gabarito_MT[4]==vet_respostas[138-135]){
          respostas_MT[contadorAux,4]<-1
        }
        
        if(gabarito_MT[5]==vet_respostas[146-135]){
          respostas_MT[contadorAux,5]<-1
        }
        ...
        if(gabarito_MT[7]==vet_respostas[140-135]){
          respostas_MT[contadorAux,7]<-1
        }
        ...
        if(gabarito_MT[11]==vet_respostas[147-135]){
          respostas_MT[contadorAux,11]<-1
        }
        ...
        if(gabarito_MT[18]==vet_respostas[150-135]){
          respostas_MT[contadorAux,18]<-1
        }
        
        if(gabarito_MT[19]==vet_respostas[151-135]){
          respostas_MT[contadorAux,19]<-1
        }
        ...
        if(gabarito_MT[24]==vet_respostas[156-135]){
          respostas_MT[contadorAux,24]<-1
        }
        
        if(gabarito_MT[25]==vet_respostas[157-135]){
          respostas_MT[contadorAux,25]<-1
        }
        
        if(gabarito_MT[26]==vet_respostas[158-135]){
          respostas_MT[contadorAux,26]<-1
        }
        
        if(gabarito_MT[27]==vet_respostas[155-135]){
          respostas_MT[contadorAux,27]<-1
        }
        ...
        if(gabarito_MT[30]==vet_respostas[167-135]){
          respostas_MT[contadorAux,30]<-1
        }
        
        if(gabarito_MT[31]==vet_respostas[168-135]){
          respostas_MT[contadorAux,31]<-1
        }
        
        if(gabarito_MT[32]==vet_respostas[166-135]){
          respostas_MT[contadorAux,32]<-1
        }
        
        if(gabarito_MT[33]==vet_respostas[165-135]){
          respostas_MT[contadorAux,33]<-1
        }
        
        if(gabarito_MT[34]==vet_respostas[171-135]){
          respostas_MT[contadorAux,34]<-1
        }
        ...
        if(gabarito_MT[36]==vet_respostas[169-135]){
          respostas_MT[contadorAux,36]<-1
        }
        
        if(gabarito_MT[37]==vet_respostas[176-135]){
          respostas_MT[contadorAux,37]<-1
        }
        ...
        if(gabarito_MT[43]==vet_respostas[172-135]){
          respostas_MT[contadorAux,43]<-1
        }
        
        if(gabarito_MT[44]==vet_respostas[174-135]){
          respostas_MT[contadorAux,44]<-1
        }
        
        if(gabarito_MT[45]==vet_respostas[175-135]){
          respostas_MT[contadorAux,45]<-1
        } 
      }
